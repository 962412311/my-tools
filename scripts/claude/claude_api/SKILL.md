---
name: claude-api
description: "Use when code imports anthropic or @anthropic-ai/sdk, or when the user asks to use the Claude API, Anthropic SDKs, or Managed Agents. Do not use when the task is general programming, ML or data-science work, or code that is explicitly built around openai or another AI SDK."
